    ...
    <tbody>
        ...
        <tr>
            <td><strong>Ctrl + Shift + Home</strong>
                <br>Mac: <strong>Command + Shift + Up</strong>
            </td>
            <td>Selects from current location or selection to start.</td>
        </tr>
        <tr>
            <td><strong>Ctrl + Home</strong>
                <br>Mac: <strong>Command + Home</strong> or <strong>Command + Up</strong>
            </td>
        ...
        <tr>
            <td><strong>Ctrl + Shift + End</strong>
                <br>Mac: <strong>Command + Shift + Down</strong>
            </td>
            <td>Selects from current location to end of document.</td>
        </tr>
        <tr>
            <td><strong>Ctrl + End</strong>
                <br>Mac: <strong>Command + End</strong> or <strong>Command + Down</strong>
            </td>
        ...
        <tr>
            <td><strong>Ctrl + Z</strong>
                <br>Mac: <strong>Command + Z</strong>
            </td>
            <td>Undo</td>
        </tr>
        <tr>
            <td><strong>Ctrl + Shift + Z</strong> or <strong>Ctrl + Y</strong>
                <br>Mac: <strong>Command + Shift + Z</strong> or <strong>Command + Y</strong>
            </td>
            <td>Redo</td>
        </tr>
        <tr>
            <td><strong>Alt + Shift + Up</strong>
                <br>Mac: <strong>Command + Option + Up</strong>
            </td>
            <td>Copy current line up</td>
        </tr>
        <tr>
            <td><strong>Alt + Up</strong>
                <br>Mac: <strong>Option + Up</strong>
            </td>
            <td>Move current line up</td>
        </tr>
        <tr>
            <td><strong>Alt + Shift + Down</strong>
                <br>Mac: <strong>Command + Option + Down</strong>
            </td>
        ...
        <tr>
            <td><strong>Alt + Backspace</strong>
                <br>Mac: <strong>Command + Backspace</strong>
            </td>
